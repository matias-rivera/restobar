...
export const TABLE_ALL_ACTIVE_REQUEST = 'TABLE_ALL_ACTIVE_REQUEST'
export const TABLE_ALL_ACTIVE_SUCCESS = 'TABLE_ALL_ACTIVE_SUCCESS'
export const TABLE_ALL_ACTIVE_FAIL = 'TABLE_ALL_ACTIVE_FAIL'
export const TABLE_ALL_ACTIVE_RESET = 'TABLE_ALL_ACTIVE_RESET'

export const TABLE_ALL_FREE_REQUEST = 'TABLE_ALL_FREE_REQUEST'
export const TABLE_ALL_FREE_SUCCESS = 'TABLE_ALL_FREE_SUCCESS'
export const TABLE_ALL_FREE_FAIL = 'TABLE_ALL_FREE_FAIL'
export const TABLE_ALL_FREE_RESET = 'TABLE_ALL_FREE_RESET'
