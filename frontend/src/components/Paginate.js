    ...
    return pages > 1 && (
        <ul className="pagination"  >
            <Link  style={{ pointerEvents: page > 1 ? '' : 'none'}} to={
               ...
               : `/${item}/page/${page-1}`
               }><li className="page-item" ><span className='page-link' style={{color: page > 1 ? '' : 'gray'}}>Previous</span></li></Link>
            ...
            <Link  style={{ pointerEvents: page < pages ? '' : 'none'}} to={
               ...
               ? `/${item}/search/${keyword}/page/${page+1}`
               : `/${item}/page/${page+1}`
               }><li className="page-item"><span className='page-link' style={{color: page < pages ? '' : 'gray'}}>Next</span></li></Link>
